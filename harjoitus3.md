...
i. Erilaisia mahdollisia käyttökohteita sisätilapaikannukselle koulun kampuksella voisi olla:
	- navigointipalvelu
	- yhteisösovellus
	- käyttäjien seuranta, datan analysointi ja visualisointi
	- opetus (e-learning)
	- pelillisyys
...
ii. Mitkä ovat järjestelmän keskeiset käyttötapaukset? Mille käyttäjäryhmälle?
	- Oppilas kirjaa itsensä tunnille
	- Opettaja näkee ketkä ovat olleet paikalla
